...
dataFrame <- dataFrame %>% 
  mutate(across(c(Meal, Country, DistributionChannel, MarketSegment, ReservedRoomType, AssignedRoomType, DepositType, Agent, Company, CustomerType, BookingCancelled, IsRepeatedGuest, ReservationStatus), ~ factor(.)))
