...
```{r}
topFive <- select(dataFrame, "ArrivalDate", "GroupSize", "BookingCancelled")
topFive <- topFive[topFive$BookingCancelled!="No",]
topFive <- topFive[order(topFive$GroupSize, decreasing = TRUE), ]
